...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-cmp', 'FixCursorHold.nvim', 'lspsaga.nvim', 'nvim-colorizer.lua', 'nvim-lspconfig', 'nvim-lsp-installer', 'nvim-treesitter', 'Comment.nvim', 'null-ls.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
