...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'gitsigns.nvim', 'nvim-lsp-installer', 'nvim-cmp', 'lspsaga.nvim', 'nvim-lspconfig', 'nvim-colorizer.lua', 'nvim-treesitter', 'Comment.nvim', 'null-ls.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
